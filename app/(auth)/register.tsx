...
import { Box, Button, ButtonText, Center, Checkbox, CheckboxGroup, CheckboxIcon, CheckboxIndicator, CheckboxLabel, CheckIcon, FormControl, Heading, Input, InputField, InputIcon, InputSlot, Text, Toast, ToastDescription, ToastTitle, useToast, VStack } from '@gluestack-ui/themed'
                    ...
                    <VStack space='xl'>
                        ...
                        <VStack space='md'>
                            ...
                            <VStack space="sm" mt="$2">
                                <Text size="sm" color="$text500" fontWeight="$bold">I am a:</Text>
